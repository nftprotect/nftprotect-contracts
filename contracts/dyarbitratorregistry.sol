...
contract DyArbitratorRegistry is Ownable
{
    ...
    event ArbitratorAddRequested(uint256 indexed requestId, uint256 disputeId, address manager, IArbitrableProxy indexed arbAddr);
        ...
        string              calldata  evidence) public payable
    {
        ...
        emit ArbitratorAddRequested(disputeId, externalDisputeId, _msgSender(), arb);
    }
